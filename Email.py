...
def get_credentials():
    ...
    if not credentials or credentials.invalid:
        ...
        print("In emailTest file...exiting get_credentials function")
    return credentials
...
def create_message_and_send(sender, to, subject,  message_text_plain, message_text_html, attached_file):
    ...
    ## with attachment
    print('calling create_message_with_attachment')
    ...
    print('calling send_message_with_attachment')
...
def create_Message_with_attachment(sender, to, subject, message_text_plain, message_text_html, attached_file):
    ...
    print('assigning mimetype and encoding')
